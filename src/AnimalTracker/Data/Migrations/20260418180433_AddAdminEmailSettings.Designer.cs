...
namespace AnimalTracker.Data.Migrations
{
    ...
    [Migration("20260418180433_AddAdminEmailSettings")]
    partial class AddAdminEmailSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimalTracker.Data.Entities.AppSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("DefaultAuthImageRelativePath")
                        .HasMaxLength(512)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("EmailUserNameProtected")
                        .HasMaxLength(1024)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AnimalTracker.Data.Entities.PhotoImportBatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("CreatedSightings")
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("PhotoImportBatches");
                });

            modelBuilder.Entity("AnimalTracker.Data.Entities.PhotoImportItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("RecognizedLabel")
                        .HasMaxLength(300)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AnimalTracker.Data.Entities.Sighting", b =>
                {
                    ...
                    b.Property<int?>("IndividualConfidence")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<DateTime?>("ObservedUntilUtc")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int?>("SpeciesConfidence")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("OwnerUserId", "AnimalId", "OccurredAtUtc");

                    b.HasIndex("OwnerUserId", "Latitude", "Longitude");

                    b.HasIndex("OwnerUserId", "SpeciesId", "OccurredAtUtc");
            ...
            modelBuilder.Entity("AnimalTracker.Data.Entities.SightingPhoto", b =>
                {
                    ...
                    b.Property<DateTime?>("OriginalCaptureUtc")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("AnimalTracker.Data.Entities.PhotoImportItem", b =>
                {
                    b.HasOne("AnimalTracker.Data.Entities.PhotoImportBatch", "Batch")
                        .WithMany("Items")
